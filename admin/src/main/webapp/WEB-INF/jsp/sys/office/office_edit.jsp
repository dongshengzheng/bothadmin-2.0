...
<form class="form-horizontal" action="office/edit" method="post"
    ...
    <div class="modal-body">
        <div class="container-fluid">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <select class="form-control" id="parentId" name="parentId">
                        <option value="${office.parentId}">${parentOfficeName}</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input id="code" name="code" type="text" maxlength="32" value="${office.code}"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input id="sort" name="sort" type="text" maxlength="32" value="${office.sort}"
